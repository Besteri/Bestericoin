...
//#endif
 ...
 //   {
  ...
  //      }
//
 //       string strDesc = "Bestericoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"besteri.ru", "46.43.220.154"},
    {"besteri.ru", "46.43.220.159"},
	{NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Bestericoin is probably already running."), addrBind.ToString().c_str());
        else
